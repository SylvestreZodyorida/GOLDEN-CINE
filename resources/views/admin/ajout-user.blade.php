                  ...
                  <div class="card-body">
                    <div class="">
                        <div class="">
                            ...
                            <form class="container" method="POST" action="{{ route('envoie-admin') }}">
                              @csrf

                              <div class="row mb-3">
                                  <label class="col-md-4 col-form-label text-md-end" for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                  <div class="col-md-6">
                                      <input id="name" placeholder="nom de l'admin" type="text" class="input form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus>
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-6">
                                      <input id="surname" placeholder="prénom de l'admin" type="text" class="input form-control @error('name') is-invalid @enderror" name="surname" value="{{ old('surname') }}" required autocomplete="surname" autofocus>
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-6">
                                      <input id="email" placeholder=" Adresse e-mail de l'admin" type="email" class="input form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-6">
                                      <input id="password" placeholder="mot de passe fort" type="password" class="input form-control @error('password') is-invalid @enderror" name="password" value="$2y$10$fLPh/ZDV7TK6db0zjrMc..wef/ByKNyjMzyHvwsm7HybLwiRshAUy" readonly required autocomplete="new-password">
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-6">
                                      <input id="password-confirm" placeholder="Confirmer le mot de passe" type="password" value="$2y$10$fLPh/ZDV7TK6db0zjrMc..wef/ByKNyjMzyHvwsm7HybLwiRshAUy" class="input  form-control" name="password_confirmation" required autocomplete="new-password"  readonly>
                                  </div>
                              </div>
                              ...
                              <div class="row mb-3">
                                  ...
                                  <div class="col-md-6">
                                      <input id="" placeholder="" type="text" class="input  form-control" name="role" required autocomplete="new-password" value="admin" readonly>
                                  </div>
                              </div>
