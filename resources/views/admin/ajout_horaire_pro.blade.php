                  ...
                  <div class="card-body">
                    <div class="">
                        <div class="">
                            ...
                            <form method="POST" action="{{ route('envoie-horaire') }}" enctype="multipart/form-data">
                                @csrf
                                
                                <div class="row mb-3">
                                    <label for="titre"  class="col-md-4 col-form-label text-md-end">Date de projection</label>

                                    <div class="col-md-6">
                                        <input id="titre"  type="date" class="form-control @error('date_pro') is-invalid @enderror" name="date_pro" value="{{ old('date_pro') }}" required autocomplete="titre" autofocus>
                                ...
                                <div class="row mb-3">
                                    <label for="titre"  class="col-md-4 col-form-label text-md-end">Heure de projection</label>

                                    <div class="col-md-6">
                                        <input id="titre"  type="time" class="form-control @error('titre') is-invalid @enderror" name="heure_pro" value="{{ old('heure_pro') }}" required autocomplete="titre" autofocus>
