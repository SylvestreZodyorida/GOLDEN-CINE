            ...
            <li class="nav-item nav-profile dropdown">
              ...
              <div class="dropdown-menu navbar-dropdown " aria-labelledby="profileDropdown">
                <a class="dropdown-item info_admin" href="#">
                  <i class="mdi mdi-cached me-2 text-success"></i> Historique d'activité </a>
            ...
            <li class="nav-item dropdown">
              ...
              <div class="drop_admin2 dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                ...
                <a class="dropdown-item preview-item">
                  ...
                  <div class="preview-item-content d-flex align-items-start flex-column justify-content-center">
                    <h6 class="preview-subject font-weight-normal mb-1">Paramètres</h6>
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="{{route('liste-reservation')}}">Consulter toutes les réservations</a></li>
                </ul>
              </div>
            </li>
            <li class="nav-item">
                  ...
                  <div class="card-body">
                    <div class="">
                        <div class="">
                            ...
                            <form method="POST" action="{{ route('envoie-film') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row mb-3">
                                    <label for="titre"  class="col-md-4 col-form-label text-md-end">Titre</label>

                                    <div class="col-md-6">
                                        <input id="titre" placeholder="titre du film" type="text" class="form-control @error('titre') is-invalid @enderror" name="titre" value="{{ old('titre') }}" required autocomplete="titre" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="synopsis" placeholder="Le synopsis du film" type="text" class="form-control @error('synopsis') is-invalid @enderror" name="synopsis" value="{{ old('synopsis') }}" required autocomplete="synopsis" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="duree" placeholder="ex: 1h:45min " type="text" class="form-control @error('duree') is-invalid @enderror" name="duree" value="{{ old('duree') }}" required autocomplete="duree">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <Select class="form-control" name="genre">
                                            <option value="">Selectionner une genre de film</option>
                                ...
                                <div class="row mb-3">
                                    <label for="genre" class="col-md-4 col-form-label text-md-end">Date de projection</label>

                                    <div class="col-md-6">
                                        
                                        <Select class="form-control" name="horaire_id">
                                            <option value="">Selectionner une horaire</option>
                                            @foreach($horairePros as $horairePro)
                                                <option  value="{{ $horairePro->id }}">{{ $horairePro->date_pro }}  {{ $horairePro->heure_pro }} </option>
                                            @endforeach
                                        </Select>
                                ...
                                <div class="row mb-3">
                                    <label for="acteurs" class="col-md-4 col-form-label text-md-end">Acteurs</label>

                                    <div class="col-md-6">
                                        <input id="acteurs" placeholder="acteurs du film"  type="text" class="form-control @error('acteurs') is-invalid @enderror" name="acteurs" value="{{ old('acteurs') }}" required autocomplete="acteurs">
                                ...
                                <div class="row mb-3">
                                    <label for="acteurs" class="col-md-4 col-form-label text-md-end">Image </label>

                                    <div class="col-md-6">
                                        <input class="col-md-4 col-form-label text-md-end" type="file" name="image" id="">
                                        @error('acteurs')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
