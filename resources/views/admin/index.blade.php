          ...
          <div class="card-body card-body-padding d-flex align-items-center justify-content-between">
            <div class="ps-lg-1">
              <div class="d-flex align-items-center justify-content-between">
                <a href="" target="_blank" class="btn me-2 buy-now-btn border-0">Bienvenu ! Vous êtes connecté en temps qu'administrateur</a>
              </div>
            </div>
            <div class="d-flex align-items-center justify-content-between">
              <a href="https://www.bootstrapdash.com/product/purple-bootstrap-admin-template/"></a>
          ...
          <div class="content-wrapper">
              ...
              @if(isset($clients))
                ...
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Total de Clients <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
            ...
            <div class="">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    @if(isset($clients))
                      ...
                      @else
                                <tr>
                                    <td class="tb_cent">Aucun client  enrégistré ! 🤔</td>
                                    <td class="tb_cent">Aucun client enrégistré ! 🤔</td>
                                </tr>
                                <td>
                                  <div class="progress">
              ...
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title text-blue">Liste de choses à faire</h4>
                    <div class="add-items d-flex">
                      <input type="text" class="form-control todo-list-input" placeholder="Que voulezvous faire aujourd'hui ?">
                    ...
                    <div class="list-wrapper">
                      <ul class="d-flex flex-column-reverse todo-list todo-list-custom">
                        <li>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="checkbox" type="checkbox"> Ajouter un administrateur </label>
                          </div>
                        ...
                        <li class="completed">
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="checkbox" type="checkbox" checked> Générer des rappots </label>
                          </div>
                          <i class="remove mdi mdi-close-circle-outline"></i>
                        </li>
                        <li>
                        ...
                        <li>
                          <div class="form-check">
                            <label class="form-check-label">
                              <input class="checkbox" type="checkbox"> Vérifier les paiements </label>
                          </div>
                          <i class="remove mdi mdi-close-circle-outline"></i>
                        </li>
