          ...
          <div class="content-wrapper">
              ...
              @if(isset($films))
                ...
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Total de Film <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{ count($films) }}</h2>
            ...
            <div class="">
              <div class="col-md-13 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tous les films</h4>
                    ...
                    @if(isset($films))
                      @if(count($films)>0)
                        @foreach($films as $film)
                              <tr>
                                ...
                                <td> {{ $film->duree }} </td>
                                <td> {{ $film->genre }} </td>
                                <td> {{ $film->horaire_id }} </td>
                                <td> {{ $film->image }} </td>
                                <td>
                                    <a class="btn btn-warning " href="{{ route('film-edit', ['film'=>$film->id]) }}">Editer</a>
                                </td>
                                <td class="tb_cent" >
                                  <a class="btn btn-primary " href="#" onclick="if(confirm('Confirmer la suppression ?')){document.getElementById('form-{{$film->id}}').submit() }">Supprimer</a>
                                </td>
                                

                              </tr>
                                <form id="form-{{$film->id}}" action="{{route('film-supp', ['film'=>$film->id])}}" method="post">
                                    @csrf
                      ...
                      @else
                                <tr>
                                    <td class="tb_cent">Aucun film  ajouté ! 🤔</td>
