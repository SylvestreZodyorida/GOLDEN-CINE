          ...
          <div class="content-wrapper">
              ...
              @if(isset($horaires))
                ...
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Total des horaires de projection <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
                    <h2 class="mb-5">{{ count($horaires) }}</h2>
            ...
            <div class="">
              <div class="col-md-13 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Toutes les horaires de projection</h4>
                    ...
                    @if(isset($horaires))
                      @if(count($horaires)>0)
                        @foreach($horaires as $horaire)
                              <tr>
                                <td> {{ $loop->index + 1}}  </td>
                                <td> {{ $horaire->date_pro }} </td>
                                <td> {{ $horaire->heure_pro }} </td>
                                <td>
                                    <a class="btn btn-warning " href="{{ route('horaire-edit', ['horaire'=>$horaire->id]) }}">Editer</a>
                                </td>
                                <td class="tb_cent" >
                                  <a class="btn btn-primary " href="#" onclick="if(confirm('Confirmer la suppression ?')){document.getElementById('form-{{$horaire->id}}').submit() }">Supprimer</a>
                                </td>
                                

                              </tr>
                                <form id="form-{{$horaire->id}}" action="{{route('horaire-supp', ['horaire'=>$horaire->id])}}" method="post">
                                    @csrf
                      ...
                      @else
                                <tr>
                                    <td class="tb_cent">Aucune horaire ajouté ! 🤔</td>
