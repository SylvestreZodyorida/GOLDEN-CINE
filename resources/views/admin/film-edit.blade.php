                        ...
                        <div class="">
                            ...
                            <form method="POST" action="{{ route('envoie-film') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="titre" placeholder="titre du film" type="text" class="form-control @error('titre') is-invalid @enderror" name="titre" value="{{ $films->titre }}" required autocomplete="titre" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <textarea id="synopsis" placeholder="Le synopsis du film" type="text" class="form-control @error('synopsis') is-invalid @enderror" name="synopsis" value="{{ $films->synopsis }}" required autocomplete="synopsis" autofocus>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="duree" placeholder="ex: 1h:45min " type="text" class="form-control @error('duree') is-invalid @enderror" name="duree" value="{{ $films->duree }}" required autocomplete="duree">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <Select class="form-control" name="horaire_id">
                                            <option value="">Selectionner une horaire</option>
                                                ...
                                                <option  value="{{ $horairePros->id }}">{{ $horairePros->date_pro }}  {{ $horairePros->heure_pro }} </option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                        <input id="acteurs" placeholder="acteurs du film"  type="text" class="form-control @error('acteurs') is-invalid @enderror" name="acteurs" value="{{ $films->acteurs }}" required autocomplete="acteurs">
