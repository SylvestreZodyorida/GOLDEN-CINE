          ...
          <div class="content-wrapper">
              ...
              @if(isset($paiements))
                ...
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h2 class="mb-5">{{ count($paiements) }}</h2>
            ...
            <div class="">
              <div class="col-md-13 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tous les paiements effectués</h4>
                    ...
                    @if(isset($paiements))
                      @if(count($paiements)>0)
                        @foreach($paiements as $paiement)
                              <tr>
                                <td> {{ $loop->index + 1}}  </td>
                                <td> {{ $paiement->transaction_status }} </td>
                                <td> {{ $paiement->id_user }} </td>
                                <td> {{ $paiement->id_film }} </td>
                      ...
                      @else
                                <tr>
                                    <td class="tb_cent">Aucun paiement effectué ! 🤔</td>
